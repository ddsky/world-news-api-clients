...
defmodule WorldNewsAPI.Api.News do
  ...
  - `{:ok, WorldNewsAPI.Model.ExtractNewsResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec extract_news(Tesla.Env.client, String.t, boolean(), keyword()) :: {:ok, WorldNewsAPI.Model.ExtractNewsResponse.t} | {:error, Tesla.Env.t}
  def extract_news(connection, url, analyze, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, WorldNewsAPI.Model.ExtractNewsResponse}
    ])
  end
  ...
  - `opts` (keyword): Optional parameters
    ...
    - `:"sub-domain"` (boolean()): Whether to include links to news on sub-domains.

  ### Returns

  - `{:ok, WorldNewsAPI.Model.ExtractLinksResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec extract_news_links(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, nil} | {:ok, WorldNewsAPI.Model.ExtractLinksResponse.t} | {:error, Tesla.Env.t}
  def extract_news_links(connection, url, api_key, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, WorldNewsAPI.Model.ExtractLinksResponse},
      {401, false},
      {402, false},
      {403, false},
      {404, false},
  ...
  - `{:ok, WorldNewsAPI.Model.GeoCoordinatesResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec geo_coordinates(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, WorldNewsAPI.Model.GeoCoordinatesResponse.t} | {:error, Tesla.Env.t}
  def geo_coordinates(connection, location, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, WorldNewsAPI.Model.GeoCoordinatesResponse},
      {404, false}
    ])
  end
  ...
  - `api_key` (String.t): Your API key.
  - `opts` (keyword): Optional parameters
    - `:"extract-news"` (boolean()): Whether extract news and add information such as description, publish date, and image to each item.
  ...
  - `opts` (keyword): Optional parameters
    ...
    - `:"source-countries"` (String.t): A comma-separated list of ISO 3166 country codes from which the news should originate, e.g. gb,us.
    ...
    - `:"news-sources"` (String.t): A comma-separated list of news sources from which the news should originate, e.g. https://www.bbc.co.uk
    ...
    - `:"location-filter"` (String.t): Filter news by radius around a certain location. Format is \"latitude,longitude,radius in kilometers\", e.g. 51.050407, 13.737262, 100
    ...
    - `:"sort-direction"` (String.t): Whether to sort ascending or descending.

  ### Returns

  - `{:ok, WorldNewsAPI.Model.SearchNewsResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec search_news(Tesla.Env.client, keyword()) :: {:ok, WorldNewsAPI.Model.SearchNewsResponse.t} | {:error, Tesla.Env.t}
  def search_news(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, WorldNewsAPI.Model.SearchNewsResponse}
    ])
  end
end
