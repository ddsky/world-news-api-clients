...
## Documentation for Models
 ...
 - [Model.ExtractLinksResponse](docs/ExtractLinksResponse.md)
 - [Model.ExtractNewsResponse](docs/ExtractNewsResponse.md)
 - [Model.GeoCoordinatesResponse](docs/GeoCoordinatesResponse.md)
 - [Model.News](docs/News.md)
 - [Model.NewsArticle](docs/NewsArticle.md)
 - [Model.SearchNewsResponse](docs/SearchNewsResponse.md)
