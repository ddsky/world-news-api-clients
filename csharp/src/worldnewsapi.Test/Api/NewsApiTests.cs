...
namespace worldnewsapi.Test.Api
{
    ...
    public class NewsApiTests : IDisposable
    {
        ...
        public void NewsWebsiteToRSSFeedTest()
        {
            ...
            //string url = null;
            //bool analyze = null;
            //var response = instance.NewsWebsiteToRSSFeed(url, analyze);
        ...
        public void SearchNewsTest()
        {
            ...
            //int? offset = null;
            //int? number = null;
            //var response = instance.SearchNews(text, sourceCountry, language, minSentiment, maxSentiment, earliestPublishDate, latestPublishDate, newsSources, authors, categories, entities, locationFilter, sort, sortDirection, offset, number);
