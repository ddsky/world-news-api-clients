...
namespace worldnewsapi.Test.Api
{
    ...
    public class NewsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test NewspaperFrontPages
        /// </summary>
        [Fact]
        public void NewspaperFrontPagesTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string? sourceCountry = null;
            //string? sourceName = null;
            //string? date = null;
            //var response = instance.NewspaperFrontPages(sourceCountry, sourceName, date);
            //Assert.IsType<NewspaperFrontPages200Response>(response);
        }
