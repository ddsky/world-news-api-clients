...
namespace worldnewsapi.Api
{
    ...
    public interface INewsApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="worldnewsapi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="text">The text to match in the news content (at least 3 characters). By default all query terms are expected, you can use an uppercase OR to search for any terms, e.g. tesla OR ford (optional)</param>
    ...
    public partial class NewsApi : INewsApi
    {
        ...
        {
            worldnewsapi.Client.ApiResponse<SearchNews200Response> localVarResponse = SearchNewsWithHttpInfo(text, sourceCountries, language, minSentiment, maxSentiment, earliestPublishDate, latestPublishDate, newsSources, authors, entities, locationFilter, sort, sortDirection, offset, number);
            return localVarResponse.Data;
        }
