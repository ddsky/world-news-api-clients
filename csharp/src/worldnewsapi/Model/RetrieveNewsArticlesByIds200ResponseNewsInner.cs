...
namespace worldnewsapi.Model
{
    ...
    public partial class RetrieveNewsArticlesByIds200ResponseNewsInner : IValidatableObject
    {
        ...
        /// <param name="catgory">catgory.</param>
        ...
        public RetrieveNewsArticlesByIds200ResponseNewsInner(string summary = default(string), string image = default(string), decimal sentiment = default(decimal), string catgory = default(string), string language = default(string), string title = default(string), string url = default(string), string sourceCountry = default(string), int id = default(int), string text = default(string), string publishDate = default(string), List<string> authors = default(List<string>))
        {
        ...
        /// </summary>
        [DataMember(Name = "catgory", EmitDefaultValue = true)]
