...
class NewsApi
{
    ...
    public function searchNewsRequest($text = null, $text_match_indexes = null, $source_country = null, $language = null, $min_sentiment = null, $max_sentiment = null, $earliest_publish_date = null, $latest_publish_date = null, $news_sources = null, $authors = null, $categories = null, $entities = null, $location_filter = null, $sort = null, $sort_direction = null, $offset = null, $number = null, string $contentType = self::contentTypes['searchNews'][0])
    {
        ...
        if ($source_country !== null && strlen($source_country) > 100) {
            throw new \InvalidArgumentException('invalid length for "$source_country" when calling NewsApi.searchNews, must be smaller than or equal to 100.');
        }
        if ($source_country !== null && !preg_match("/./", $source_country)) {
