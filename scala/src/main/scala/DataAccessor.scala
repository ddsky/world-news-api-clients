...
trait DataAccessor {
    ...
    private object TODO extends CommonError("Not implemented") {
        ...
        */
        def News_extractNews(url: String, analyze: Boolean, authParamapiKey: String): Either[CommonError,InlineResponse2001] = Left(TODO)

        /**
        * 
        * @return A InlineResponse2002
        */
        def News_geoCoordinates(location: String, authParamapiKey: String): Either[CommonError,InlineResponse2002] = Left(TODO)

        /**
        * 
        * @return A InlineResponse200
        */
        def News_searchNews(text: Option[String], sourceCountries: Option[String], language: Option[String], minSentiment: Option[Double], maxSentiment: Option[Double], earliestPublishDate: Option[String], latestPublishDate: Option[String], newsSources: Option[String], authors: Option[String], entities: Option[String], locationFilter: Option[String], offset: Option[Int], number: Option[Int], sort: Option[String], sortDirection: Option[String], authParamapiKey: String): Either[CommonError,InlineResponse200] = Left(TODO)
