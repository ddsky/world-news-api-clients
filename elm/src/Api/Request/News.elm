...
-}
extractNewsLinks : String -> Bool -> Api.Request Api.Data.ExtractNewsLinks200Response
...
-}
newsWebsiteToRSSFeed : String -> Bool -> Api.Request (Dict.Dict String Api.Data.Object)
newsWebsiteToRSSFeed url_query analyze_query =
    Api.request
        "GET"
        "/feed.rss"
        []
