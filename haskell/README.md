## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `World News API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the World News API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | WorldNews                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | world-news                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | WorldNewsConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | WorldNewsRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| WorldNews.Client    | use the "dispatch" functions to send requests       |
| WorldNews.Core      | core functions, config and request types            |
| WorldNews.API       | construct api requests                              |
| WorldNews.Model     | describes api models                                |
| WorldNews.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| WorldNews.ModelLens | lenses for model fields                             |
| WorldNews.Logging   | logging functions and utils                         |
