...
export class NewsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public newspaperFrontPages(sourceCountry?: string, sourceName?: string, date?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<NewspaperFrontPages200Response>;
    public newspaperFrontPages(sourceCountry?: string, sourceName?: string, date?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<NewspaperFrontPages200Response>>;
    public newspaperFrontPages(sourceCountry?: string, sourceName?: string, date?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<NewspaperFrontPages200Response>>;
    public newspaperFrontPages(sourceCountry?: string, sourceName?: string, date?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        return this.httpClient.request<NewspaperFrontPages200Response>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
