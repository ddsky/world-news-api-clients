...
export class NewsService {
    ...
    public extractNewsLinks(url: string, analyze: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        if (analyze === null || analyze === undefined) {
            throw new Error('Required parameter analyze was null or undefined when calling extractNewsLinks.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public newsWebsiteToRSSFeed(url: string, analyze: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/xml', context?: HttpContext, transferCache?: boolean}): Observable<object>;
    public newsWebsiteToRSSFeed(url: string, analyze: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/xml', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<object>>;
    public newsWebsiteToRSSFeed(url: string, analyze: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/xml', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<object>>;
    public newsWebsiteToRSSFeed(url: string, analyze: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/xml', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling newsWebsiteToRSSFeed.');
        }
        if (analyze === null || analyze === undefined) {
            throw new Error('Required parameter analyze was null or undefined when calling newsWebsiteToRSSFeed.');
        }
