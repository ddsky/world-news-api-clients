...
public class NewsApi {
  ...
  */
  public NewspaperFrontPages200Response newspaperFrontPages (String sourceCountry, String sourceName, String date) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;

    // create path and map variables
    String path = "/front-pages";
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (NewspaperFrontPages200Response) ApiInvoker.deserialize(localVarResponse, "", NewspaperFrontPages200Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Newspaper Front Pages
   * Get the front pages of newspapers from around the world. The API provides images of the front pages of newspapers from different countries. Here&#39;s an example of some of today&#39;s newspapers:
   * @param sourceCountry The ISO 3166 country code of the newspaper publication.   * @param sourceName The identifier of the publication see attached list.   * @param date The date for which the front page should be retrieved.
  */
  public void newspaperFrontPages (String sourceCountry, String sourceName, String date, final Response.Listener<NewspaperFrontPages200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;


    // create path and map variables
    String path = "/front-pages".replaceAll("\\{format\\}","json");
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((NewspaperFrontPages200Response) ApiInvoker.deserialize(localVarResponse,  "", NewspaperFrontPages200Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
