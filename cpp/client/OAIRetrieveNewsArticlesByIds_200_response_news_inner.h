...
public:
    ...
    QString getCatgory() const;
    void setCatgory(const QString &catgory);
    bool is_catgory_Set() const;
    bool is_catgory_Valid() const;
...
private:
    ...
    QString m_catgory;
    bool m_catgory_isSet;
    bool m_catgory_isValid;
