...
/*
 * OAIExtractNewsResponse.h
 *
 * 
 */

#ifndef OAIExtractNewsResponse_H
#define OAIExtractNewsResponse_H
...
class OAIExtractNewsResponse : public OAIObject {
public:
    OAIExtractNewsResponse();
    OAIExtractNewsResponse(QString json);
    ~OAIExtractNewsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExtractNewsResponse)

#endif // OAIExtractNewsResponse_H
