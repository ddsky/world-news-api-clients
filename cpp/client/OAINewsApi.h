...
Q_SIGNALS:
    ...
    void extractNewsSignal(OAIExtractNewsResponse summary);
    void extractNewsLinksSignal(OAIExtractLinksResponse summary);
    void geoCoordinatesSignal(OAIGeoCoordinatesResponse summary);
    void newsWebsiteToRSSFeedSignal(OAIObject summary);
    void searchNewsSignal(OAISearchNewsResponse summary);

    void extractNewsSignalFull(OAIHttpRequestWorker *worker, OAIExtractNewsResponse summary);
    void extractNewsLinksSignalFull(OAIHttpRequestWorker *worker, OAIExtractLinksResponse summary);
    void geoCoordinatesSignalFull(OAIHttpRequestWorker *worker, OAIGeoCoordinatesResponse summary);
    void newsWebsiteToRSSFeedSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void searchNewsSignalFull(OAIHttpRequestWorker *worker, OAISearchNewsResponse summary);

    Q_DECL_DEPRECATED_X("Use extractNewsSignalError() instead")
    void extractNewsSignalE(OAIExtractNewsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void extractNewsSignalError(OAIExtractNewsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use extractNewsLinksSignalError() instead")
    void extractNewsLinksSignalE(OAIExtractLinksResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void extractNewsLinksSignalError(OAIExtractLinksResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use geoCoordinatesSignalError() instead")
    void geoCoordinatesSignalE(OAIGeoCoordinatesResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void geoCoordinatesSignalError(OAIGeoCoordinatesResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void searchNewsSignalE(OAISearchNewsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void searchNewsSignalError(OAISearchNewsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use geoCoordinatesSignalErrorFull() instead")
    void geoCoordinatesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void geoCoordinatesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
