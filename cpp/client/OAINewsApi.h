...
public:
    ...
    * @param[in]  analyze bool [required]
    */
    void extractNewsLinks(const QString &url, const bool &analyze);
    ...
    * @param[in]  analyze bool [required]
    */
    void newsWebsiteToRSSFeed(const QString &url, const bool &analyze);
    ...
    */
    void newspaperFrontPages(const ::OpenAPI::OptionalParam<QString> &source_country = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &source_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &date = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void newspaperFrontPagesCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void newspaperFrontPagesSignal(OAINewspaperFrontPages_200_response summary);
    ...
    void newspaperFrontPagesSignalFull(OAIHttpRequestWorker *worker, OAINewspaperFrontPages_200_response summary);
    ...
    Q_DECL_DEPRECATED_X("Use newspaperFrontPagesSignalError() instead")
    void newspaperFrontPagesSignalE(OAINewspaperFrontPages_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void newspaperFrontPagesSignalError(OAINewspaperFrontPages_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use newspaperFrontPagesSignalErrorFull() instead")
    void newspaperFrontPagesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void newspaperFrontPagesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
