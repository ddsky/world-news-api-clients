...
pub async fn extract_news(configuration: &configuration::Configuration, url: &str, analyze: bool) -> Result<crate::models::InlineResponse2001, Error<ExtractNewsError>> {
...
/// Search for news.
pub async fn search_news(configuration: &configuration::Configuration, text: Option<&str>, source_countries: Option<&str>, language: Option<&str>, min_sentiment: Option<f64>, max_sentiment: Option<f64>, earliest_publish_date: Option<&str>, latest_publish_date: Option<&str>, news_sources: Option<&str>, authors: Option<&str>, entities: Option<&str>, location_filter: Option<&str>, offset: Option<i32>, number: Option<i32>, sort: Option<&str>, sort_direction: Option<&str>) -> Result<crate::models::InlineResponse200, Error<SearchNewsError>> {
    let local_var_configuration = configuration;
