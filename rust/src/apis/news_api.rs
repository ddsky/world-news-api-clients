...
pub async fn extract_news_links(configuration: &configuration::Configuration, url: &str, analyze: bool) -> Result<models::ExtractNewsLinks200Response, Error<ExtractNewsLinksError>> {
    let local_var_configuration = configuration;
...
pub async fn news_website_to_rss_feed(configuration: &configuration::Configuration, url: &str, analyze: bool) -> Result<serde_json::Value, Error<NewsWebsiteToRssFeedError>> {
    let local_var_configuration = configuration;
...
pub async fn search_news(configuration: &configuration::Configuration, text: Option<&str>, source_country: Option<&str>, language: Option<&str>, min_sentiment: Option<f64>, max_sentiment: Option<f64>, earliest_publish_date: Option<&str>, latest_publish_date: Option<&str>, news_sources: Option<&str>, authors: Option<&str>, categories: Option<&str>, entities: Option<&str>, location_filter: Option<&str>, sort: Option<&str>, sort_direction: Option<&str>, offset: Option<i32>, number: Option<i32>) -> Result<models::SearchNews200Response, Error<SearchNewsError>> {
    let local_var_configuration = configuration;
