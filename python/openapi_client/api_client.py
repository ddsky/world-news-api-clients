...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.extract_news  # this is an instance of the class Endpoint
        api_instance.extract_news()  # this invokes api_instance.extract_news.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.extract_news.callable or self.callable in this class
