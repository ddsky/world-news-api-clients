...
class RetrieveNewsArticlesByIds200Response(BaseModel):
    """
    RetrieveNewsArticlesByIds200Response
    """

  # noqa: E501
    news: Optional[List[RetrieveNewsArticlesByIds200ResponseNewsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "news": [
                RetrieveNewsArticlesByIds200ResponseNewsInner.from_dict(_item)
