...
class SearchNewsSources200Response(BaseModel):
    """
  ...
  # noqa: E501
    ...
    sources: Optional[List[SearchNewsSources200ResponseSourcesInner]] = None
    __properties: ClassVar[List[str]] = ["available", "sources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            obj.get("available"),
            "sources": [
                SearchNewsSources200ResponseSourcesInner.from_dict(_item)
