...
class RetrieveNewsArticlesByIds200ResponseNewsInner(BaseModel):
    """
  ...
  # noqa: E501
    ...
    catgory: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = [
        "summary", "image", "sentiment", "catgory", "language", "title", "url",
        "source_country", "id", "text", "publish_date", "authors"
    ]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if catgory (nullable) is None
        # and model_fields_set contains the field
        if self.catgory is None and "catgory" in self.model_fields_set:
            _dict['catgory'] = None
