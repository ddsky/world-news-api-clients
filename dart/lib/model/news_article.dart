...
class NewsArticle {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NewsArticle &&
    other.id == id &&
    other.title == title &&
    other.text == text &&
  ...
  @override
  String toString() => 'NewsArticle[id=$id, title=$title, text=$text, summary=$summary, url=$url, image=$image, publishDate=$publishDate, author=$author, language=$language, sourceCountry=$sourceCountry, sentiment=$sentiment]';
  ...
  static List<NewsArticle> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<NewsArticle>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<NewsArticle>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = NewsArticle.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
