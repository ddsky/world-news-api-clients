...
// tests for RetrieveNewsArticlesByIds200ResponseNewsInner
void main() {
  // final instance = RetrieveNewsArticlesByIds200ResponseNewsInner();

  group('test RetrieveNewsArticlesByIds200ResponseNewsInner', () {
    // String summary
