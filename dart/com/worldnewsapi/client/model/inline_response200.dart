...
class InlineResponse200 {
  ...
  List<InlineResponse200News> news;
  ...
  @override
  String toString() => 'InlineResponse200[offset=$offset, number=$number, available=$available, news=$news]';
  ...
  static InlineResponse200 fromJson(dynamic value) {
    if (value is Map) {
      ...
      return InlineResponse200(
        ...
        news: InlineResponse200News.listFromJson(json[r'news']),
      );
    }
    return null;
  }
