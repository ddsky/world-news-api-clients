...
#
# newspaper_front_pages test
#
# uncomment below and update the test
#my $newspaper_front_pages_source_country = undef; # replace NULL with a proper value
#my $newspaper_front_pages_source_name = undef; # replace NULL with a proper value
#my $newspaper_front_pages_date = undef; # replace NULL with a proper value
#my $newspaper_front_pages_result = $api->newspaper_front_pages(source_country => $newspaper_front_pages_source_country, source_name => $newspaper_front_pages_source_name, date => $newspaper_front_pages_date);
