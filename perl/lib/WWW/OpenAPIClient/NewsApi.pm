...
sub extract_news {
    ...
    my $_response_object = $self->{api_client}->deserialize('ExtractNewsResponse', $response);
...
sub extract_news_links {
    ...
    my $_response_object = $self->{api_client}->deserialize('ExtractLinksResponse', $response);
    return $_response_object;
}
...
# @param string $location The address or name of the location, e.g. Tokyo, Japan. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'geo_coordinates' } = {
        ...
        params => $params,
        returns => 'GeoCoordinatesResponse',
        };
}
...
sub geo_coordinates {
    ...
    my $_response_object = $self->{api_client}->deserialize('GeoCoordinatesResponse', $response);
    return $_response_object;
}
...
sub search_news {
    ...
    my $_response_object = $self->{api_client}->deserialize('SearchNewsResponse', $response);
    return $_response_object;
}
