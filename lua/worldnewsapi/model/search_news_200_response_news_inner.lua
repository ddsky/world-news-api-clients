...
local function new_search_news_200_response_news_inner(summary, image, sentiment, author, language, video, title, url, source_country, id, text, category, publish_date, authors)
