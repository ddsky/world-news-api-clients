...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Worldnewsapi.RetrieveNewsArticlesByIds200ResponseNewsInner();
  });
  ...
  describe('RetrieveNewsArticlesByIds200ResponseNewsInner', function() {
    it('should create an instance of RetrieveNewsArticlesByIds200ResponseNewsInner', function() {
      // uncomment below and update the code to test RetrieveNewsArticlesByIds200ResponseNewsInner
      //var instance = new Worldnewsapi.RetrieveNewsArticlesByIds200ResponseNewsInner();
      //expect(instance).to.be.a(Worldnewsapi.RetrieveNewsArticlesByIds200ResponseNewsInner);
    });
    ...
    it('should have the property catgory (base name: "catgory")', function() {
      // uncomment below and update the code to test the property catgory
      //var instance = new Worldnewsapi.RetrieveNewsArticlesByIds200ResponseNewsInner();
      //expect(instance).to.be();
    });
