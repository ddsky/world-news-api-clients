...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WorldNewsApi.SearchNewsResponse();
  });
  ...
  describe('SearchNewsResponse', function() {
    it('should create an instance of SearchNewsResponse', function() {
      // uncomment below and update the code to test SearchNewsResponse
      //var instance = new WorldNewsApi.SearchNewsResponse();
      //expect(instance).to.be.a(WorldNewsApi.SearchNewsResponse);
    });
