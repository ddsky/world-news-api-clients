...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WorldNewsApi.ExtractNewsResponse();
  });
  ...
  describe('ExtractNewsResponse', function() {
    it('should create an instance of ExtractNewsResponse', function() {
      // uncomment below and update the code to test ExtractNewsResponse
      //var instance = new WorldNewsApi.ExtractNewsResponse();
      //expect(instance).to.be.a(WorldNewsApi.ExtractNewsResponse);
    });
