...
(function(root, factory) {
  ...
  describe('NewsApi', function() {
    ...
    describe('newspaperFrontPages', function() {
      it('should call newspaperFrontPages successfully', function(done) {
        //uncomment below and update the code to test newspaperFrontPages
        //instance.newspaperFrontPages(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
