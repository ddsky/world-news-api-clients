...
export default class NewsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the newspaperFrontPages operation.
     * @callback module:api/NewsApi~newspaperFrontPagesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/NewspaperFrontPages200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [date] The date for which the front page should be retrieved.
     * @param {module:api/NewsApi~newspaperFrontPagesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/NewspaperFrontPages200Response}
     */
    newspaperFrontPages(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = NewspaperFrontPages200Response;
      return this.apiClient.callApi(
        '/front-pages', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
